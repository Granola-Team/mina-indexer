...
test_indexer_cli_reports() {
    ...
    idxr snapshots create --help 2>&1 |
        grep -iq "Usage: mina-indexer create-snapshot"

    idxr snapshots restore --help 2>&1 |
...
test_snapshot() {
    ...
    idxr create-snapshot --output-dir "$SNAPSHOT_DIR"
    ...
    idxr restore-snapshot --snapshot-file-path snapshot_"$DATE"_"$DB_VERSION"_.tar.gz --restore-dir "$SNAPSHOT_DIR"
