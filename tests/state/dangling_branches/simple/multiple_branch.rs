...
async fn extensions() {
    ...
    let (extension_type, _) = state.add_block(&root0_block).unwrap();
    ...
    let (extension_type, _) = state.add_block(&child10_block).unwrap();
    assert_eq!(extension_type, ExtensionType::DanglingNew);
    ...
    let (extension_type, _) = state.add_block(&child0_block).unwrap();
    ...
    let (extension_type, _) = state.add_block(&root1_block).unwrap();
    ...
    let (extension_type, _) = state.add_block(&child11_block).unwrap();
    assert_eq!(extension_type, ExtensionType::DanglingSimpleForward);
