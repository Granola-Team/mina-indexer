use crate::{constants::RUNNING_AVG_MINIMUM_DATA_POINTS, event_sourcing::block_ingestion_actors::blockchain_tree_builder_actor::BlockchainTreeBuilderActor};
...
pub async fn subscribe_actors(
    ...
    let actors: Vec<Arc<dyn Actor + Send + Sync>> = vec![
        ...
        Arc::new(MonitorActor::new(Arc::clone(shared_publisher), RUNNING_AVG_MINIMUM_DATA_POINTS, Some(1_000))),
