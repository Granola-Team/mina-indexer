...
use crate::{
    ...
    event_sourcing::payloads::{BlockCanonicityUpdatePayload, NewBlockPayload},
};
...
async fn test_non_canonical_block_with_vrf_info() -> anyhow::Result<()> {
    use crate::{
        ...
        event_sourcing::payloads::{BlockCanonicityUpdatePayload, GenesisBlockPayload, NewBlockPayload},
    };
