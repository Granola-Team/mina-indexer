...
use crate::{
    bin_prot_test,
    protocol::bin_prot::common::{
        BInner, BInner2, BInner3, BInner4, CInner, CInner2, A, B, B2, B3, C,
    },
};
...
fn test_float() {
    bin_prot_test! {
        0x3c 0xb0 00 00 00 00 00 00 -> 2.220_446_049_250_313E-16,
        0x7f 0xf0 00 00 00 00 00 00 -> f64::INFINITY,
        0x7f 0xef 0xff 0xff 0xff 0xff 0xff 0xff -> 1.797_693_134_862_315_7E308,
        0x7f 0xf0 00 00 00 00 00 00 -> f64::INFINITY,
